...
dummy = DummyClassifier(strategy='most_frequent', random_state = 100, constant = None) 
dummy.fit(X, y) 
...
print ("Dummy Model 2, strategy: most frequent, accuracy {0:.2f}, precision {0:.2f}, recall {0:.2f}, f1-score {0:.2f}"\
